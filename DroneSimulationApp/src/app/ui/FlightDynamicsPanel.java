...
public class FlightDynamicsPanel extends JPanel {
    ...
    public FlightDynamicsPanel(MainFrame frame) {
         ...
         * @param e the {@code MouseEvent} that initiated the {@code ToolTip} display
         */
     ...
     *
     * @param flightData reference to the FlightData object containing dynamic data
     */
    private void loadData(FlightData flightData) {
        ...
        for (DroneDynamics d : dynamics) {
            ...
            DroneType name = DataRepository.getInstance().getDroneTypeByUrl(instance.getDroneType());
