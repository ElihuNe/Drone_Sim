...
public class DroneCatalogPanel extends JPanel {
    ...
    public DroneCatalogPanel(MainFrame frame) {
        ...
        JTable table = new JTable(model) {
             ...
             *
             * @param e the {@code MouseEvent} that initiated the
             *              {@code ToolTip} display
             * @return the {@code String} to display as the {@code ToolTip}
             */
            @Override
         ...
         * @param evt the {@code MouseEvent} that initiated the {@code ToolTip} display
         *
         */
            ...
            public void mouseClicked(MouseEvent evt) {
                ...
                if (row >= 0) {
                    ...
                    for (Drone drone : drones) {
                        DroneType instance = DataRepository.getInstance().getDroneTypeByUrl(drone.getDroneType());
